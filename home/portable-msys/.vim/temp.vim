...
nnoremap QIL :IndentLinesToggle<CR>
"}}}
"}}}
...
if !empty(globpath(&rtp, 'autoload/smooth_scroll.vim'))
  if has('gui_running')
    ...
    nnoremap <silent> <C-a> :call smooth_scroll#up(&scroll, 5, 2)<CR>
    nnoremap <silent> <C-u> :call smooth_scroll#up(&scroll, 5, 2)<CR>
    nnoremap <silent> <C-h> :call smooth_scroll#up(4, 5, 1)<CR>
    nnoremap <silent> <C-l> :call smooth_scroll#down(4, 5, 1)<CR>
  else
...
function! MyHighlights() abort
  ...
  hi TabLineSel cterm=bold,underline ctermbg=0 ctermfg=7
  hi TabLine cterm=none ctermbg=none ctermfg=246
