...
" function! xmooth_xcroll#up(dist, duration, speed)
"   call Xmooth_xcroll('u', a:dist, a:duration, a:speed)
" endfunction
...
" function! xmooth_xcroll#down(dist, duration, speed)
"   call Xmooth_xcroll('d', a:dist, a:duration, a:speed)
" endfunction
...
function! s:smooth_scroll(dir, dist, duration, speed)
  for i in range(a:dist/a:speed)
    ...
    if a:dir ==# 'd'
      ...
      exec "normal! ".a:speed."\<C-e>".a:speed
    else
      " exec "normal! ".a:speed."\<C-y>".a:speed."k"
      exec "normal! ".a:speed."\<C-y>".a:speed
    endif
    redraw
...
function! Xmooth_xcroll(dir, dist, duration, speed)
  for i in range(a:dist/a:speed)
    let start = reltime()
    if a:dir ==# 'd'
